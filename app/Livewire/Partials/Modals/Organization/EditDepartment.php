...
class EditDepartment extends ModalComponent
{
    ...
    //Properties
    public $id, $department, $internal_id, $name, $remarks;

    public function mount($id){
        $this->department = Department::where('id', $id)->first();

        $this->internal_id = $this->department->internal_id;
        $this->name = $this->department->name;
        $this->remarks = $this->department->remarks;
    }

    public function update(){
        try{
            DB::beginTransaction();
                Department::where('id', $this->id)->update([
