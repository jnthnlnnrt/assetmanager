...
class AssetManager extends Tailwind
{
    ...
    public function table(): array
    {
        return [
            'layout' => [
                'base'      => 'p-3 align-middle inline-block min-w-full w-full',
                ...
                'container' => '-my-2 overflow-x-auto sm:-mx-3',
                'actions'   => 'flex gap-2',
            ],
            ...
            'header' => [
                ...
                'tr'       => '',
                'th'       => 'font-extrabold px-3 py-2 text-left text-xs text-pg-primary-700 tracking-wider whitespace-nowrap dark:text-pg-primary-300',
                'thAction' => '!font-bold',
            ],
            ...
            'body' => [
                ...
                'tbodyEmpty'         => '',
                'tr'                 => 'border-b border-pg-primary-100 even:bg-white dark:border-pg-primary-600 hover:bg-pg-primary-50 dark:bg-pg-primary-800 dark:hover:bg-pg-primary-700',
                'td'                 => 'px-3 py-1.5 whitespace-nowrap dark:text-pg-primary-200',
    ...
    public function footer(): array
    {
        return [
            ...
            'select' => 'appearance-none !bg-none focus:ring-primary-600 focus-within:focus:ring-primary-600 focus-within:ring-primary-600 dark:focus-within:ring-primary-600 flex rounded-md ring-1 transition focus-within:ring-2 dark:ring-pg-primary-600 dark:text-pg-primary-300 text-gray-600 ring-gray-300 dark:bg-pg-primary-800 bg-white dark:placeholder-pg-primary-400 rounded-md border-0 bg-transparent py-1 px-4 pr-7 ring-0 placeholder:text-gray-400 focus:outline-none sm:text-sm sm:leading-6 w-auto',
        ];
    }
    ...
    {
        return [
            'th'    => 'px-4 py-1.5 text-left text-xs font-medium text-pg-primary-500 tracking-wider',
            'base'  => '',
